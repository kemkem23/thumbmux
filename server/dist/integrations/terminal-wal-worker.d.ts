...
import { type OutputWalFormat, type OutputWalGap, type OutputWalRecoverySnapshot, type OutputWalRecord } from "../output-wal";
import { type TerminalGeometry, type TerminalWalIdentity, type TerminalWalPaths } from "./terminal-wal";
