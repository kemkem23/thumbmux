...
export declare function createSqliteHistoryStore(options: SqliteHistoryOptions): Promise<{
    ...
    createRolloutRouter: (o: {
        allowlist: InstanceType<typeof import("./sqlite-history/rollout").HistoryRolloutAllowlist>;
    ...
    expandGroup: (allowlist: InstanceType<typeof import("./sqlite-history/rollout").HistoryRolloutAllowlist>, group: string, o: {
        mirrorDirectory: string;
