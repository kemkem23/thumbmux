import type { AnsiPalette, ClaudeBashSummaryRequest, LaunchPreset, LaunchSpec, PreferencesAdapter, SessionListItem, SubmitAgent, TerminalSurfaceWithPalette, UploadedFile } from '@thumbmux/core';
