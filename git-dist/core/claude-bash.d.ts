 ...
 */
export declare function detectClaudeBashBlocksWithActivityEvidence(rawLines: readonly string[], provenActivityStatusLines: readonly number[], options?: ClaudeBashDetectionOptions): ClaudeBashDetection;
/**
