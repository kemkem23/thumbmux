import { type LaunchPreset, type LaunchSpec, type SessionListItem, type SessionListRow } from "../core/index.js";
...
export type SpawnHandlerOptions<SessionRow extends SessionListRow = SessionListItem> = {
...
export declare function createSpawnHandler<SessionRow extends SessionListRow = SessionListItem>(opts?: SpawnHandlerOptions<SessionRow>): (req: Request) => Promise<Response>;
export {};
