 ...
 */
import { type MuxClientMessage, type MuxFullOutputFrame, type MuxHistoryBoundary, type MuxPaneScreen, type SessionListItem, type SessionListRow } from "../core/index.js";
export type WsLike = {
...
export declare class TmuxWsMux<WS extends WsLike = WsLike, SessionRow extends SessionListRow = SessionListItem> {
    ...
    private sendHistoryReadErrorBestEffort;
