...
export type HttpOperation = "static" | "auth-description" | "ws-upgrade" | "sessions-list" | "sessions-spawn" | "recordings-list" | "recordings-download" | "recording-start" | "recording-stop" | "upload";
/**
