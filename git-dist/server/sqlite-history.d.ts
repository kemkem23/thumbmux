...
import type * as rollout from './sqlite-history/rollout.js';
...
export { expandGroup, runRestoreDrill } from './sqlite-history/rollout.js';
export type { BackupAuditEntry, BackupAuditReport, ExpansionReceipt, GroupReadinessEvidence, HistoryWriter, LegacyArtifactDigest, LegacyRetirementReceipt, RestoreDrillReceipt, RolloutGroupState, RolloutRoute } from './sqlite-history/rollout.js';
export declare function createSqliteHistoryStore(options: SqliteHistoryOptions): Promise<{
    ...
    }) => rollout.HistoryRolloutAllowlist;
    createRolloutRouter: (o: {
        allowlist: InstanceType<typeof import("./sqlite-history/rollout.js").HistoryRolloutAllowlist>;
        sqlite: rollout.HistoryWriter;
        legacy: rollout.HistoryWriter;
    }) => rollout.HistoryRolloutRouter;
    assessGroupReadiness: (group: string, mirrorDirectory: string) => Promise<rollout.GroupReadinessEvidence>;
    expandGroup: (allowlist: InstanceType<typeof import("./sqlite-history/rollout.js").HistoryRolloutAllowlist>, group: string, o: {
        mirrorDirectory: string;
        scratchDirectory: string;
    }) => Promise<rollout.ExpansionReceipt>;
    auditBackupCoverage: (mirrorDirectory: string) => rollout.BackupAuditReport;
    restoreDrill: (bundleDirectory: string, scratchDirectory: string) => Promise<rollout.RestoreDrillReceipt>;
