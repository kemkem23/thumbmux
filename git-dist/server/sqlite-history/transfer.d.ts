...
import type { HistoryImportOptions, HistoryImportProgress, HistoryImportState } from './types.js';
type SealedFile = {
    path: string;
    bytes: number;
    sha256: string;
...
export declare const HOST_CHUNKS_SIDECARS: ReadonlySet<string>;
export declare function isHostChunksOrphanJson(name: string, listed: ReadonlySet<string>): boolean;
